...
import {LayoutDashboard,Settings,LogOut,ChevronDown,GraduationCap,Users,BookOpen,DoorOpen,CalendarDays,ShieldCheck} from 'lucide-react';
...
export const AppSidebar:React.FC<Props>=({activeTab,onTabChange,campus,onMyCampuses,onLogout})=><aside className="examio-sidebar">
